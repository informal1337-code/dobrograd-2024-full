...
octoinv.registerItem('scissors', {
   name = L.tool_scissors,
   icon = 'eastcoast/icons/scissors.png',
   mass = 0.1,
   volume = 0.1,
   randomWeight = 0.25,
   desc = descTemp,
...
octoinv.registerItem('plastic_bag', {
   name = L.plastic_bag,
   icon = 'eastcoast/icons/plastic_bag.png',
   mass = 0.1,
   volume = 0.1,
   randomWeight = 0.25,
   desc = DescTemp,
