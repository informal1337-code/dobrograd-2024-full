...
File Path:   addons/core-octochat/lua/octochat/client.lua
...
octolib.bind.registerHandler('chat', {
	...
	buildBinder = function(cont, bindID, bind)
		...
		local onChange = function(self)
			octolib.bind.set(bindID, bind.button, bind.action, self:GetValue(), bind.on)
		end
