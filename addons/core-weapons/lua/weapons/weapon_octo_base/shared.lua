...
function SWEP:CanFire()
	...
	t.endpos = self:__RANDOMIZE_GetShootPosAndDir__()
	t.filter = ply
	return not util.TraceLine(t).Hit

end

function SWEP:__RANDOMIZE_GetShootPosAndDir__()
...
function SWEP:PrimaryAttack()
	...
	local shootPos, shootDir = self:__RANDOMIZE_GetShootPosAndDir__()
