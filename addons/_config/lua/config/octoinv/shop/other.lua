...
-- Добавляем категорию для товаров гровера
octoinv.addShopCat('weed', {
    name = 'Гидропоника',
    icon = 'octoteam/icons/weed_category.png', -- Нужно создать эту иконку
})

-- Добавляем товары в категорию
octoinv.addShopItem('weed_pot', {
    cat = 'weed',
...
octoinv.addShopItem('weed_water', {
    cat = 'weed',
