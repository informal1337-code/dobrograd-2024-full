...
netstream.Hook('launcher.notFound', function(notFound)
	...
	function f:OnClose()
		chat.AddText(unpack(octolib.string.splitByUrl('Для полноценной игры на этом сервере требуется лаунчер для Garry\'s Mod от нашей команды. Чтобы узнать о его возможностях и скачать установщик, можно зайти на сайт по адресу https://discord.gg/TsC2bDm75v')))
	end
