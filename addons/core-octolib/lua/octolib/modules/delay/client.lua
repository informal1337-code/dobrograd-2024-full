...
octolib.delayedActions.active = octolib.delayedActions.active or {}
surface.CreateFont('octolib.use', {
    font = 'Calibri',
    extended = true,
    size = 82,
...
netstream.Hook('octolib.delayedActions', function(e, o, i, t)
    local e = e
    local o = o
    if o then
        octolib.delayedActions.active[e] = {
            text = i,
            start = CurTime(),
            time = t - CurTime(),
        }
    else
        octolib.delayedActions.active[e] = nil
    end
end)