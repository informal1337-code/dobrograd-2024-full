...
function ENT:Initialize()
    ...
    self.uid = self.uid or octolib.string.uuid() -- ��������, ��� UID ������ �����������
end
...
function ENT:OnRemove()
    if self.uid then -- ���������, ��� UID �� nil
        timer.Remove('octoinv.entExpire' .. self.uid)
    else
        ErrorNoHalt("ENT:OnRemove - self.uid is nil! This should not happen.\n")
    end
end