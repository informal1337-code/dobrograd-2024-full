...
function category:Create(base)
	...
	base.panel.unlockType:SetToolTip("Changes how the MOTD closes.");
	...
	category.url:SetToolTip("The website to load when opened.");
	...
	base.panel.delayLabel:SetToolTip("How long you need to wait before you can close the MOTD.");
