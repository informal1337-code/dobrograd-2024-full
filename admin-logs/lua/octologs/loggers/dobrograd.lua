...
hook.Add('PlayerTransferMoney', 'octologs.transfer', function(sender, receiver, amount)
    octologs.createLog(octologs.CAT_OTHER)
        :Add(octologs.ply(sender, {'wallet'}), ' → ', octologs.num(amount, '₽'), ' → ', octologs.ply(receiver, {'wallet'}))
        :Save()
end)
