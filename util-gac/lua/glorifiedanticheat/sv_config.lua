...
gAC.storage.Type = "mysql" -- Types: flatfile, sqlite, mysql

-- MySQL Settings ("mysql" module only)
gAC.storage.hostname = "localhost"
gAC.storage.username = "root"
gAC.storage.password = ""
gAC.storage.database = "dbg"
gAC.storage.port = 3306

gAC.config.IMMUNE_USERS = { -- Set all the people you want to be immune to detections here, SteamID64s only.
    ["76561198061230671"] = false, -- NiceCream
    ["76561198073308340"] = false, -- GlorifiedPig
    ["76561198285864038"] = true -- kniga
}
...
--[[ BAN SYSTEM SETTINGS ]]--
    ...
    gAC.config.BAN_MESSAGE_SYNTAX = "cheats" -- Syntax for ban messages.
    ...
    gAC.config.BAN_TYPE = "serverguard"
...
--[[General cheating detections]]
    ...
    --[[ ANTI Movement Manipulation SETTINGS ]]--
        -- WARNING, This detection is untested!
        gAC.config.ANTI_MOVEMANIP = true
...
--[[Account related detections]]
    ...
    gAC.config.FAMILY_SHARE_BANTIME = 0 -- Set to '0' for permban, '-1' for kick and anything above for ban time in minutes.
