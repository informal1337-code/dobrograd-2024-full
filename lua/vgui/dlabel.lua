...
function PANEL:UpdateColours( skin )
    ...
    if ( self:GetHighlight() ) then return self:SetTextStyleColor( skin.Colours.Label.Highlight:Lerp( frac, gray ) ) end
    if ( self:GetBright() ) then return self:SetTextStyleColor( skin.Colours.Label.Bright:Lerp( frac, gray ) ) end
    if ( self:GetDark() ) then return self:SetTextStyleColor( skin.Colours.Label.Dark:Lerp( frac, gray ) ) end

    return self:SetTextStyleColor( skin.Colours.Label.Default:Lerp( frac, gray ) )
