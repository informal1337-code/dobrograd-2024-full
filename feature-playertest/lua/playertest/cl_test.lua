...
function test.welcomeScreen(attempts, hint, showMsg)
	...
	local play = octolib.button(cont, 'Начать игру', function(self)
		netstream.Start('dbg-test.answer', 20)
	...
	local links = octolib.button(bp, 'Ссылки', function()
		local m = DermaMenu()
		m:AddOption(L.rules_server, function() octoesc.OpenURL('https://discord.gg/TsC2bDm75v') end)
		m:AddOption(L.forum, function() octoesc.OpenURL('https://discord.gg/TsC2bDm75v') end)
		m:AddOption(L.wiki, function() octoesc.OpenURL('https://discord.gg/TsC2bDm75v') end)
		m:AddOption(L.we_in_steam, function() octoesc.OpenURL('https://discord.gg/TsC2bDm75v') end)
		m:AddOption(L.we_in_vk, function() octoesc.OpenURL('https://discord.gg/TsC2bDm75v') end)
		m:AddOption(L.our_site, function() octoesc.OpenURL('https://discord.gg/TsC2bDm75v') end)
		m:AddOption(L.write_us_in_vk, function() octoesc.OpenURL('https://discord.gg/TsC2bDm75v') end)
		m:Open()
	end)
	links:SetWide(115)
	links:Dock(LEFT)
...
function test.create(quiz, toPass, onCancel, onSubmit)
	...
	local butRules = octolib.button(bp1, 'Правила', function()
		octoesc.OpenURL('https://discord.gg/TsC2bDm75v')
	end)
	butRules:Dock(LEFT)
